...
PHP7.0 で動かない箇所があったので修正

□ver. 140314_0 (beta)
XSLT が使えないブラウザでも過去ログを表示できるように変更
RSS のバージョンを 2.0 に変更
PubSubHubbub に対応

□ver. 140310_0 (beta)
IE11 で非同期読み込み全般ができなくなっていたのを修正
conf の reloadsec に具体的な説明を追加

□ver. 130608_0 (beta)
IE10 で非同期読み込み全般ができなくなっていたのを修正

□ver. 120429_0 (beta)
IE7 でリロード時にエラーが出ていたのを修正
IE7 で離脱ボタンが機能していなかったのを修正

□ver. 120417_0 (beta)
パーミッションの変更条件がおかしかったのを修正
リバースプロキシ利用時にもなるべくうまく動くように修正

□ver. 120410_2 (beta)
更新 ping で送信する URL を変更
